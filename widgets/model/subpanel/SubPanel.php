    ...
    public function defaultConfig()
    {
        return [
            ...
            'header' => [
                'tag' => 'div',
                'options' => [
                    'class' => 'row widget-model-subpanels-subpanel-header subpanel-for-model-{{ t.getModelClassName( widget.emptyRelatedModel) | lower }}'
                ],
                'heading' => [
                    'tag' => 'div',
                    'options' => [
                ...
                'buttons' => [
                    ...
                    'items' => [
                        'create' => "<a href=\"{{ widget.emptyRelatedModel.getUrl('create', {(widget.relatedField.relatedField): widget.model.id}) }}\" class=\"btn btn-primary btn-sm button-for-model-{{ t.getModelClassName( widget.emptyRelatedModel) | lower }}\">Create {{ widget.emptyRelatedModel.getModelConfig('label') }}</a>"
                    ]
                ]
            ],
