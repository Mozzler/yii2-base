...
class SubPanel extends BaseWidget
{
    ...
    public function defaultConfig()
    {
        return [
            ...
            'relationConfig' => [
                ...
                'filter' => [],
                'offset' => null,
                'orderBy' => ['createdAt' => SORT_DESC], // Order by newest first by default
                'fields' => null,
    ...
    public function code($templatify = false)
    {
        ...
        if (!isset($config['dataProvider'])) {
            ...
            // -- Is a locally saved relateMany array?
            ...
            // Check to see if the above dataProvider was created
            if (!isset($config['dataProvider'])) {

                // -- It's likely other models referencing this one
